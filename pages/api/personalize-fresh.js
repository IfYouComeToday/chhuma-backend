// pages/api/personalize-fresh.js
...
export default async function handler(req, res) {
  ...
  console.log("FRESH API endpoint reached, method:", req.method);
  ...
  try {
    ...
    // THIS ENDPOINT ALWAYS SKIPS THE CACHE
    console.log(`Fresh endpoint - bypassing chatOutputs cache for ${email || linkedInUrl}`);
